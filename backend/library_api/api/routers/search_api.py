...
from backend.library_api.api.schemas.search_schema import SearchQuery, SearchResult, AddToIndexRequest
from backend.library_api.services.search_service import SearchService
from backend.library_api.utils.search import get_or_create_index, search_index
...
def api_get_or_create_index(index_dir: str = Body(...)):
    try:
        ...
        from backend.library_api.utils.search import validate_index_directory
