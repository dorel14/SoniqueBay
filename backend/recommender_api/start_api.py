...
from recommender_api.api_app import create_api
...
if __name__ == "__main__":
    uvicorn.run("reommender.api_app:app",
                host="0.0.0.0",
                port=8002,
                ...
                reload_dirs=("/recommender_api"), # Dossiers à surveiller pour le rechargement)
                ) 