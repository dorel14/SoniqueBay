...
class User(Base):
    """Modèle minimal User pour satisfaire les contraintes FK en tests/intégration."""
...
class ConversationModel(Base, TimestampMixin):
    ...
    waiting_for: Mapped[List[str]] = mapped_column(JSON, nullable=False, default=[])

    # Relation avec l'utilisateur
    user = relationship(
        "User", back_populates="conversations", lazy="select", single_parent=True
    )
