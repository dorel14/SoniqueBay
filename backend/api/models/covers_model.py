...
from sqlalchemy import Integer, String, DateTime, Enum, func, UniqueConstraint, Index
...
class Cover(Base):
    ...
    entity_type: Mapped[EntityCoverType] = mapped_column(
        Enum(EntityCoverType, name="covertype"), nullable=False
    )
