...
from backend.api.graphql.types.artist_type import (
    ArtistCreateInput,
    ArtistType,
    ArtistUpdateInput,
)
...
class ArtistMutations:
    ...
    @strawberry.mutation
    async def create_artist(self, data: ArtistCreateInput, info: Info) -> ArtistType:
        """Create a new artist."""
    ...
    async def create_artists(
        self, data: list[ArtistCreateInput], info: Info
    ) -> list[ArtistType]:
    ...
    async def update_artist_by_id(
        self, data: ArtistUpdateInput, info: Info
    ) -> ArtistType:
        ...
        artist_data_dict: dict[str, str | None] = {}
    ...
    @strawberry.mutation
    async def upsert_artist(self, data: ArtistCreateInput, info: Info) -> ArtistType:
