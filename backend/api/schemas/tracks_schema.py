...
class TrackBase(BaseModel):
    ...
    track_number: Optional[str] = Field(
        None, description="Numéro de piste (ex: '01/12')"
    )
    ...
    genre_main: Optional[str] = Field(
        None, description="Genre principal détecté par analyse audio"
    )
    ...
    musicbrainz_artistid: Optional[str] = Field(
        None, description="MusicBrainz Artist ID"
    )
    musicbrainz_albumartistid: Optional[str] = Field(
        None, description="MusicBrainz Album Artist ID"
    )
    acoustid_fingerprint: Optional[str] = Field(
        None, description="AcoustID Fingerprint"
    )
