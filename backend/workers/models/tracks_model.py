...
from backend.workers.models.tags_model import GenreTag, MoodTag

if TYPE_CHECKING:
    from backend.workers.models.track_audio_features_model import TrackAudioFeatures
    from backend.workers.models.track_embeddings_model import TrackEmbeddings
    from backend.workers.models.track_metadata_model import TrackMetadata
    ...
    from backend.workers.models.track_mir_synthetic_tags_model import (
