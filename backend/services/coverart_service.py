...
async def get_cover_schema(api_url: str = os.environ.get("API_URL","http://api:8001")) -> dict:
...
async def get_cover_types(api_url: str = os.environ.get("API_URL","http://api:8001")) -> list:
