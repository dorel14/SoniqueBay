...
class MIRPipelineService:
    ...
    def __init__(self) -> None:
        ...
        from backend.services.genre_taxonomy_service import GenreTaxonomyService
        from backend.services.synthetic_tags_service import SyntheticTagsService
    ...
    async def _extract_raw_features(
        ...
        try:
            from backend.services.audio_features_service import (
