...
if TYPE_CHECKING:
    import httpx
    import joblib
    from backend.services.vectorization_service import OptimizedVectorizationService
    from backend.services.data_directory_initializer import initialize_data_directories
...
try:
    import httpx
    import joblib
    from backend.services.vectorization_service import OptimizedVectorizationService, _DummyTextVectorizer, _DummyAudioVectorizer, _DummyTagClassifier
    from backend.services.data_directory_initializer import initialize_data_directories
    from backend.api.utils.logging import logger
except ImportError:
        ...
        try:
            ...
            if os.environ.get("TESTING") != "true":
                ...
                from backend.services.vectorization_service import (
                    _DummyTextVectorizer,
                    _DummyAudioVectorizer,
                    _DummyTagClassifier,
                )
