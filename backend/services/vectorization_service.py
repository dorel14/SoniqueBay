...
class OptimizedVectorizationService:
    ...
    async def fetch_tracks_from_api(
        self, track_ids: Optional[List[int]] = None
    ) -> List[Dict[str, Any]]:
        """
        ...
        """
        return await self.embedding_service.fetch_tracks_from_api(track_ids or [])
    ...
    async def vectorize_and_store(
        self, track_id: int, track_data: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
        """
