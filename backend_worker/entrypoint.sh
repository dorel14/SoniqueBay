...
REQUIRED_DIRS="/app/data /app/data/models /app/data/celery_beat_data /app/data/search_indexes /app/data/whoosh_index /app/backend_worker/data /app/backend_worker/logs"
