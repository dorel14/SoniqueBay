...
@celery.task(name="backend_worker.tasks.maintenance_tasks.generate_daily_health_report_task")
...
@celery.task(name="backend_worker.tasks.maintenance_tasks.rebalance_queues_task")
...
@celery.task(name="backend_worker.tasks.maintenance_tasks.archive_old_logs_task")
...
@celery.task(name="backend_worker.tasks.maintenance_tasks.validate_system_integrity_task")
