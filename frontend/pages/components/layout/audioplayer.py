"""
Composant lecteur audio pour l'interface SoniqueBay.

Ce module fournit un composant de lecteur audio avec contrôles
de lecture, barre de progression et réglage du volume.
"""
...
def audioplayer_component():
    """
    Crée le composant lecteur audio avec contrôles.
    
    Returns:
        None: Le composant est rendu directement via NiceGUI
    """
